 ...
 * @author Balázs
 */
public class Eladas extends HttpServlet {
        ...
        try {
            ...
            while(iterator.hasNext()) {
                ...
                if(termek.getMennyiseg() >= mennyiseg) {
                    ...
                    em.merge(termek);
                    Jelentes jelentes = new Jelentes(1, datum, "eladás", termek.getTermekKod(), termek.getTermekNev(), mennyiseg);
                    em.persist(jelentes);
                }
                else {
                    throw new Exception("negatív");
                }
            }
            ...
            if(ex.getMessage().equals("negatív")){
                out.println("Nincs ekkora mennyiség készleten!<br><br>");
            } else {
